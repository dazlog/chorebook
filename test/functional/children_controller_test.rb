...
class ChildrenControllerTest < ActionController::TestCase
  ...
  test "should create child" do
    assert_difference('Child.count') do
      post :create, child: { age: @child.age, bank: @child.bank, dob: @child.dob, image: @child.image, name: @child.name, total: @child.total }
    end
  ...
  test "should update child" do
    put :update, id: @child, child: { age: @child.age, bank: @child.bank, dob: @child.dob, image: @child.image, name: @child.name, total: @child.total }
    assert_redirected_to child_path(assigns(:child))
  end
